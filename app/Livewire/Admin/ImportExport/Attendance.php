...
class Attendance extends Component
{
    ...
    public $work_mode = null; // ✅ Tambahan: filter WFH/WFO
    ...
    protected $rules = [
        ...
        'work_mode' => 'nullable|in:wfh,wfo', // ✅ Validasi tambahan
    ];
    ...
    public function render()
    {
        ...
        if ($this->file) {
            ...
            $attendances = AttendanceModel::filter(
                ...
                workMode: $this->work_mode // ✅ Gunakan work_mode
            )->get();
        } else {
    ...
    public function export()
    {
        ...
        $filename = 'attendances'
            ...
            . ($this->work_mode ? '_' . $this->work_mode : '') 
            . '.xlsx';
