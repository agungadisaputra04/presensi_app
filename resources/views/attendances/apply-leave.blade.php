<x-app-layout>
        ...
        <div class="p-6 lg:p-8">
          ...
          @enderror
                  ...
                  <div>
                    ...
                    <x-input id="to" min="{{ date('Y-m-d') }}" class="mt-1 block w-full" name="to" />
                    @error('to')
          ...
          @enderror
              ...
              <div x-data="{ filename: null, preview: null }">
                <input type="file" value="{{ old('attachment') ?? $attendance?->attachment }}" class="hidden"
                  id="attachment" name="attachment" x-ref="attachment" x-on:change="
  ...
  @pushOnce('scripts')
    ...
    document.addEventListener('DOMContentLoaded', function () {
      const disabledDates = @json($disabledDates); // Pastikan ini adalah array format 'Y-m-d'
