  ...
  <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:gap-6">
    ...
    <div>
      ...
      <form wire:submit.prevent="export">
        ...
        <div>
        <x-select id="work_mode" name="work_mode" class="mb-4" wire:model.live="work_mode">
          <option value="">{{ __('Pilih Mode Kerja') }}</option>
    ...
    <div>
      ...
      <!-- Link download format import sebagai tombol -->
      <div class="mb-4">
        <a href="{{ asset('xlsx/Template_Attendances_Import.xlsx') }}" class="inline-flex items-center px-4 py-2 bg-blue-500 border border-transparent rounded-md font-semibold text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
          Download Format Import Data Presensi
        </a>
      </div>
  ...
  <table class="w-full divide-y divide-gray-200 border dark:divide-gray-700 dark:border-gray-700">
    ...
    <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
      ...
      <tr class="{{ $trClass }}">
        ...
        <td class="{{ $tdClass }}">{{ strtoupper($attendance->work_mode ?? '-') }}</td>
