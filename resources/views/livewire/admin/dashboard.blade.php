@php
  ...
  $isWeekend = Carbon::now()->isWeekend();
    // If it's the weekend, set a different message
    $absentMessage = $isWeekend ? 'This weekend !' : "Tidak Hadir: {$absentCount}";
@endphp
<div>
  @pushOnce('styles')
  ...
  <div class="flex flex-col justify-between sm:flex-row">
    <h3 class="mb-4 text-lg font-semibold leading-tight text-gray-800 dark:text-gray-200">
      Presensi Hari Ini - {{ $currentDateTime }}
  </h3>
    <h3 class="mb-4 text-lg font-semibold leading-tight text-gray-800 dark:text-gray-200">
  ...
  <div class="mb-4 grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-4">
    ...
    <div class="rounded-md bg-blue-200 px-8 py-4 text-gray-800 dark:bg-blue-900 dark:text-white dark:shadow-gray-700">
      <span class="text-2xl font-semibold md:text-3xl">Cuti: {{ $excusedCount }}</span><br>
      <span>Izin/Cuti</span>
    </div>
    <div
    ...
    <div class="rounded-md bg-red-200 px-8 py-4 text-gray-800 dark:bg-red-900 dark:text-white dark:shadow-gray-700">
          <span class="text-2xl font-bold">Belum Hadir: {{ $absentCount }}</span><br>
      <span>{{ $isWeekend ? 'This weekend!' : 'Belum Hadir' }}</span>
  </div>
  </div>
    ...
    <table class="w-full divide-y divide-gray-200 dark:divide-gray-700">
      ...
      <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
        ...
        @foreach ($employees as $employee)
          ...
          @php
    $status = strtolower($employee->status_hari_ini ?? 'belum ada jadwal');
