...
use App\Http\Livewire\ScheduleManager;
...
Route::middleware('user')->group(function () {
    ...
    Route::prefix('admin')->middleware('admin')->group(function () {
        ...
        Route::get('/approve-leave/{id}', [LeaveApprovalController::class, 'approve'])->name('approve-leave');
        Route::get('/reject-leave/{id}', [LeaveApprovalController::class, 'reject'])->name('reject-leave');
        ...
        Route::get('/masterdata/schedule', function () {
...
//jadwal
        Route::post('/schedules/import', [ScheduleController::class, 'import'])->name('admin.schedules.import');
        Route::get('/schedules/export', [ScheduleController::class, 'export'])->name('admin.schedules.export');
